...
export function Hero() {
	...
	return (
		<div className="relative overflow-hidden">
			...
			<div className="absolute left-1/2 -translate-x-1/2 top-0 h-[500px] w-[1000px] rounded-full bg-primary/10 blur-[120px]" />
			...
			<div className="container relative z-10 pt-36 pb-20">
				...
				{/* Main headline */}
				<h1 className="mx-auto max-w-5xl text-center text-hero font-bold animate-slide-up">
					The Future of Call Centers
					<span className="gradient-blue"> is AI-Powered</span>
				</h1>
